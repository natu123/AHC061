...
fn main() {
    ...
    env::set_var("AHC_X04_TARGET_PRESSURE_WEIGHT", "1.25");
    env::set_var("AHC_X04_PRESSURE_WEIGHT", "1.05");
    env::set_var("AHC_X04_PRESSURE_WEIGHT_EARLY", "0.65");
    env::set_var("AHC_X04_PRESSURE_WEIGHT_LATE", "1.35");
    env::set_var("AHC_X04_ROUTE_PRESSURE_WEIGHT", "0.35");
    env::set_var("AHC_X04_ROUTE_PRESSURE_WEIGHT_EARLY", "0.18");
    env::set_var("AHC_X04_ROUTE_PRESSURE_WEIGHT_LATE", "0.55");
