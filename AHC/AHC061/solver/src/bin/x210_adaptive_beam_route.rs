...
fn main() {
    unsafe {
        // x47 champion params (baseline for M=4)
        ...
        // Allow x04 beam search for all M values
        env::set_var("AHC_X04_ALLOWED_M", "2,3,4,5,6,7,8");
    }
    run_with_strategy(StrategyMode::AdaptiveBeamRoute);
}
