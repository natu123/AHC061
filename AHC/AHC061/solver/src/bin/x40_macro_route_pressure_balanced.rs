...
fn main() {
    ...
    env::set_var("AHC_X04_TARGET_PRESSURE_WEIGHT", "-0.05");
    env::set_var("AHC_X04_PRESSURE_WEIGHT_EARLY", "0.15");
    env::set_var("AHC_X04_PRESSURE_WEIGHT_LATE", "-0.15");
    env::set_var("AHC_X04_ROUTE_PRESSURE_WEIGHT_EARLY", "0.05");
    env::set_var("AHC_X04_ROUTE_PRESSURE_WEIGHT_LATE", "-0.25");
